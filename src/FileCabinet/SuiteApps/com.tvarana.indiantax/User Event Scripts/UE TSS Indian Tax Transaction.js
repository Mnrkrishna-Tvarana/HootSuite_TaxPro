...
define(['./UES_TSS_Set_Codes_on_Check', './TSS UE TDS New', './TSS UE TDS On Sales', '/SuiteApps/com.tvarana.indiantax/Other Files/TSS TaxPro Server Helper'],

    (TSS_GST, TSS_TDS, TSS_TDS_Sales, serverHelper) => {
        /**
